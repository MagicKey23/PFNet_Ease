...
def getConfig():
    ...
    parser.add_argument('--train_path', type=str, default="train/custom", help='The path to the training data. Default: %(default)s ')
    ...
    parser.add_argument('--test_path', type=str, default="test/custom", help='The path to the test data. Default: %(default)s')
    ...
    parser.add_argument('--gt_object', type=int, default=1, help='How many actual object is in the image')
